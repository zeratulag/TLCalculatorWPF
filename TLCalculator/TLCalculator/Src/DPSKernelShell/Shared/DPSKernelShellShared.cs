...
namespace TLCalculator.Src
{
    ...
    public partial class DPSKernelShell
    {
        ...
        public void GetDPSKernel()
        {
            ...
            LongDPSKernel = new DPSKernel(LongFChars, CTarget, SkillDfs, SkillFreqCTDFs, FightTime.LongItem, kernelarg);
            ShortDPSKernel = new DPSKernel(ShortFChars, CTarget, SkillDfs, SkillFreqCTDFs, FightTime.ShortItem, kernelarg);
        }
