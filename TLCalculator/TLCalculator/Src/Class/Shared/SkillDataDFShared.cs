...
namespace TLCalculator.Class
{
    public partial class SkillDataDF : SkillDataDFBase
    {
        ...
        public SkillDataDF(SkillDataDF old, bool deep = false)
        {
            if (deep)
            {
                Data = old.Data.ToDictionary(_ => _.Key, _ => _.Value.DeepClone());
            }
            else
            {
        ...
        public SkillDataDF Copy(bool deep = false)
        {
            return new SkillDataDF(this, deep);
        }
