...
namespace TLCalculator.Src
{
    ...
    public partial class CalculatorShell
    {
        ...
        public CalculatorShell(CalculatorShell old): this()
        {
            if (old != null)
            {
                UpdateInput(old.InitInput, old.QiXue, old.CTarget, old.AbilityItem, old.Zhen, old.FightTime, old.Buffs,
                    old.SkillDFMiJiQiXue, old.Arg.Copy());
                Arg.EnableOptimization = false;
            }
        }
        ...
        public void UpdateInput(MainWindowModel model)
        {
            UpdateInput(model.InitInputVM,
                ...
                model.Shellbuffs, model.SkillDataDFMiJiQiXueVM.Model,
                model.CalcShellArg);
        }
        ...
        public void GetOptimizer()
        {
            ...
            MultiZhenDPSOp = new MultiZhenFaOptimizer(this);
            MultiZhenDPSOp.Calc();
        }
    }
}